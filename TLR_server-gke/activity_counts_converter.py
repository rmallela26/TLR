...
def main(file, folderInn, folderOut, requestId, filesf):
    ...
    fileInn = f'{requestId}_cleaned_motion_data.txt'
    ...
    fileOut = f'{requestId}_counts.txt'
...
def call_main(requestId):
    path = '/Users/rishabhmallela/Documents/Sleep Classification/data/'
    folderInn = path + "cleaned_motion/"
    folderOut = path + "counts2/" 

    file = 'cleaned_1066528_acceleration.txt'
    main(file, folderInn, folderOut, requestId, filesf=30)
